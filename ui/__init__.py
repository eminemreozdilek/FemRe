...
import applications.controller_homogenization.function_communication as ach
import applications.controller_material_editor.function_communication as acm
import applications.controller_static.function_communication as acs
...
class StaticWindow(MainWindow):
    ...
    def __set_communication(self):
        self.__ui.actionImportStaticModel.triggered.connect(self.__ui_functions.static_case_editor.import_static_model)
